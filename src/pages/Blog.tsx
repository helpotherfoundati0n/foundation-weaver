...
import { Footer as DayPickerFooter, DayPickerProvider, useDayPicker } from "react-day-picker";
...
function Blog() {
  ...
  return (
    <DayPickerProvider initialProps={{ mode: "single" }}>
      {/* DayPickerProvider is wrapping the component */}
...
function Footer() {
  const dayPicker = useDayPicker(); // This will throw an error if not wrapped in DayPickerProvider
